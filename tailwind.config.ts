    ...
    extend: {
      colors: {
        ...
        seat: {
          ...
          "reserved-foreground": "hsl(var(--seat-reserved-foreground))",
        },
        // Floor and table
        floor: "hsl(var(--floor))",
        table: {
          surface: "hsl(var(--table-surface))",
      ...
      keyframes: {
        ...
        "seat-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--seat-selected) / 0.4)" },
          "50%": { boxShadow: "0 0 12px 4px hsl(var(--seat-selected) / 0.6)" },
        },
        "fade-in": {
      ...
      animation: {
        ...
        "seat-select": "seat-select 0.3s ease-out",
